...
QtObject {
    ...
    // Login
    property string userQQ: "484301429";
    onUserQQChanged: ;

    property string userPass: "";
    onUserPassChanged: ;

    property bool rememberPass: false;
    onRememberPassChanged: ;

    property bool autoLogin: myqq.autoLogin;
    onAutoLoginChanged: myqq.autoLogin = autoLogin;
/*
    // system
